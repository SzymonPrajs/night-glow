...
- [ ] Decide whether Environment Atlas decoders and Physics Wasm share one coordinator worker or separate workers after profiling.
...
- [x] Approve Environment Atlas direct-to-globe display versus scientific releases-through-Physics paths; display products never feed Physics.
...
- [ ] Define an external Environment Atlas forecast publication job and atomic immutable run channel; do not fetch/process provider archives through Vercel Functions or the browser.
