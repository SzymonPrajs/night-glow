...
- Physics Wasm, catalogues, LUTs and Environment Atlas emission/atmosphere chunks load on intent, not in the application shell;
...
- no global Environment Atlas release is shipped as JSON or converted to millions of JS objects;
