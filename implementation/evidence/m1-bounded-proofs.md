...
| non-UI coordinator | `make coordinator-test` | 9 tests pass against both Wasm modules: coherent product, cancellation, stale revision, unit drift, resource budget, runtime-manifest/Physics-identity rejection, success/failure buffer release, and stable memory across 100 scenarios |
