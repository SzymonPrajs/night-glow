...
| Physics native boundary | `cargo test --manifest-path packages/physics/Cargo.toml` | 20 tests pass across typed scenarios/errors, astronomy, data, the independent Environment adapter, flat and spherical transfer primitives, external-reference validation, DAG scheduling/cancellation and Wasm output |
