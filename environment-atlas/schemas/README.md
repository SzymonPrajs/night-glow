...
The normative handoffs are [surface emission](../docs/18-physics-handoff.md) and [atmospheric state](../docs/21-atmosphere-physics-handoff.md). Each schema must encode its meanings and ship a tiny native/Wasm conformance fixture. Serialization must never create physical defaults, merge release cadences, or turn an optional `EnvironmentReleaseSet` into a combined scientific record.
