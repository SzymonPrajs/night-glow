...
Before Phase-9 integration, the atlas publishes the tiny open fixture in [18-physics-handoff.md](18-physics-handoff.md). Native and Wasm tests must agree on `J_DNB`, exact support/hierarchy, corrected reference view, profile normalization/state, time context, uncertainty, provenance, and corruption rejection.
