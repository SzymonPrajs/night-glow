...
Wavelengths at the consumer boundary are vacuum nanometres. The atlas retains this high-resolution source representation; Physics projects it into its independently selected runtime basis with a versioned, error-tested operator. The atlas is never required to emit the current application's eight bands.
