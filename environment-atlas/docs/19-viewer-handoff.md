...
The main Viewer has two modes and two relationships with Environment Atlas:
...
[`../../viewer/README.md`](../../viewer/README.md), especially its
[data contracts](../../viewer/DATA_CONTRACTS.md) and
[globe plan](../../viewer/GLOBE_VIEW.md).
...
Environment Atlas owns deterministic display-product construction and conformance
...
The Viewer's generic layer interface is not an Environment Atlas schema. Noise,
...
and incompatible/corrupt manifests. Environment Atlas tests derivation and values,
...
| Concern | Environment Atlas | Viewer | Physics |
| --- | --- | --- | --- |
