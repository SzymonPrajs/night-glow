...
The Atlas should store temperature, pressure, humidity, cloud condensate/fraction and aerosol species/bin mass where supported. It should also preserve source-supplied extinction, AOD, single-scattering albedo and asymmetry as diagnostics/constraints. Physics may use them directly under a declared source-optics mode or reconstruct optical properties under its own reviewed aerosol model.
