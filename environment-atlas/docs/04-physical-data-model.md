...
The complete Physics handoff record and canonical terms are defined in [18-physics-handoff.md](18-physics-handoff.md). In particular, `J_DNB` remains unchanged at the boundary; source wavelength/direction/time resolution is a separate, evidence-dependent conversion.
