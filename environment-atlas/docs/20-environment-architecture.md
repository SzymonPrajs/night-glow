# 20. Environment Atlas architecture
...
4. Physics depends on published domain contracts; neither Atlas domain depends on Physics internals.
...
Atlas precompute may be substantial, but interactive browser work is bounded: locate relevant spatial/vertical/time chunks, interpolate state, select/sample a scenario and hand contiguous arrays to Physics. It does not rerun a global weather model or chemical transport model in Wasm.
