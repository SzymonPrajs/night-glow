...
The normative handoff uses an explicit `EmissionTimeContext` rather than a bare instant whenever a profile requires civil, solar, sunset-relative, weekday, holiday, or event fields. The detailed batch/coordinate/profile contract is in [18-physics-handoff.md](18-physics-handoff.md).
...
The emission domain publishes the conformance fixture described in [18-physics-handoff.md](18-physics-handoff.md). A consumer either uses the released schema/format decoder crates or proves its independent decoder against that fixture.
