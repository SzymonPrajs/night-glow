...
Deploy the Next.js application shell to Vercel. Render marketing/methodology content statically and keep the two viewer routes browser-driven. Scientific computation runs in the user's worker/Wasm runtime. Large Environment emission/atmosphere, catalogue, LUT, terrain and derived display products live in content-addressed object storage behind a CDN.
