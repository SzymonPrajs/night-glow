...
- review this Viewer plan with Environment emission/atmosphere and Physics plans;
...
- resolve the high-impact decisions in [`../decisions/open-decisions.md`](../decisions/open-decisions.md).
...
- freeze Viewer-side Environment domain display contracts and Physics render-product envelope;
...
5. artificial-light propagation from Environment emission through a horizontally varying Atmosphere Field;
...
Gate: the globe's generality is demonstrated without weakening Light/Environment semantics.
