...
The proposed stack is coherent, but acceptance is conditional. Framework, map engine, tile packaging and threads each have a bounded proof and measurable rejection criterion in the roadmap. None changes the ownership rule: Environment reconstructs sources, Physics computes observer radiance, Viewer renders and interacts.
