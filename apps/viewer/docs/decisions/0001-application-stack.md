...
**Scope:** new Viewer only; does not restructure Environment emission domain or Physics
...
- **Rust/WebAssembly in module workers** for Physics and Environment decoding/adaptation;
...
- A deterministic Environment display product is likely needed in addition to its scientific lookup format.
