# Environment consumer contract

## 1. Purpose and ownership

Physics consumes two independently releasable products from the sibling
[`packages/environment/`](../../../environment/README.md) workspace:

- `EmissionRelease`, governed in detail by the
  [emission contract](emission-release.md); and
...
Environment owns source acquisition, harmonisation, data fusion,
...
The repository [unified system contract](../../../contracts/README.md) is
...
Environment supplies geolocated state and support. Physics converts it into
