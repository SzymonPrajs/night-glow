...
The [unified system contract](../../../contracts/README.md) is normative for `ObserverScenario`, `ObserverRenderProductSet`, selection/evidence vocabularies, revision identities and lifecycle names.

The application-side plan is [`../../../../apps/viewer/README.md`](../../../../apps/viewer/README.md), with normative Viewer expectations in its [data contracts](../../../../apps/viewer/docs/architecture/data-contracts.md), [observer plan](../../../../apps/viewer/docs/product/observer.md), and [rendering/worker plan](../../../../apps/viewer/docs/architecture/rendering-and-workers.md).
...
- source-profile scenario policy where Environment evidence is unresolved;
...
The browser baseline is one coordinator worker hosting Physics Wasm and optionally an Environment decoder dependency. Calls are scenario/batch/tile sized. Outputs use transferable buffers or stable Wasm views with explicit invalidation; no per-star, per-cell or per-ray JavaScript loop exists.
...
- exact provenance across both Environment products, source run/sample/scenario, Physics and Viewer revisions;
