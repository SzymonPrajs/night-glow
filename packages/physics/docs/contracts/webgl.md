...
The application-side lifecycle, scenario, and two-view boundary are specified in the independent [Viewer integration contract](viewer.md). This document remains authoritative for the meanings and GPU use of Physics render products.
