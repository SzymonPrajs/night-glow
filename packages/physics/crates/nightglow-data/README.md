...
- `atmosphere_adapter`: one-way consumer of Environment `AtmosphereFieldRelease`; preserves run/evidence/vertical/wet-dry/missingness/uncertainty semantics and emits contiguous state volumes.
...
- `emission_adapter`: one-way consumer of the independent Environment emission domain release/schema; preserves `J_DNB`, corrected reference view, profiles/status, exact support, uncertainty, provenance, and licence partition.
