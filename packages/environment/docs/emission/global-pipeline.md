...
## Stage 8 — Validate the source product
...
Feed the frozen emission release into a frozen propagation solver with measured atmosphere where possible. Compare against calibrated ground all-sky/zenith observations. Attribute residuals using source-rich and atmosphere-rich site metadata rather than tuning the source product to compensate for propagation errors.

## Stage 11 — Release and regression archive

Publish:

- Environment files and manifests;
