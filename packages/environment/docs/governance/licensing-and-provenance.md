...
- SDGSAT-1's published terms restrict data to scientific/non-commercial use, prohibit redistribution without permission, and restrict derivative compilation. It is excluded from an openly redistributable Environment release unless CBAS grants suitable permission.
...
1. **Radiometry core:** Black Marble/EOG-derived native-resolution emission release with permissive/open provenance.
...
- Do not infer that OSM or its contributors endorse Environment.
