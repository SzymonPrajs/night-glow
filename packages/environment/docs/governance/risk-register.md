...
| Snow/cloud/aurora/fires/flares contaminate stable emission release | High / high | QA and time-series outlier reports | Separate flags/layers and source classes; robust composites |
...
| Initial ground reflection is applied twice | Medium / critical | direct/first-reflected boundary audit | consume Environment value as outgoing surface signal; BRDF only for later transport orders |
