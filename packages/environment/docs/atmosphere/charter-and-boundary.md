...
| Concern | Environment atmosphere domain | Physics |
| --- | --- | --- |
...
The repository-wide [unified system contract](../../../contracts/README.md) is normative for these enum names, time identities and the distinction between evidence, selection, scientific validity and runtime availability.
