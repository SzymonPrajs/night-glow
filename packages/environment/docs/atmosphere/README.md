...
1. [Charter and boundary](charter-and-boundary.md)
2. [Research findings](research-findings.md)
3. [Source catalogue](source-catalog.md)
4. [4-D field model](field-model.md)
5. [Fusion, climatology and fallbacks](fusion-climatology-and-fallbacks.md)
6. [Format and API](format-and-api.md)
7. [Validation, licensing and risks](validation-licensing-and-risks.md)
8. [Roadmap and TODO](roadmap-and-todo.md)
9. [Normative Physics handoff](physics-handoff.md)

## Central rule

The release preserves environmental state and any source-provided optical diagnostics. Physics decides how that state becomes wavelength-dependent extinction, absorption, scattering and phase functions. This prevents the Environment from silently choosing Physics' aerosol optics and prevents Physics from pretending that PM2.5 alone is a complete optical medium.
