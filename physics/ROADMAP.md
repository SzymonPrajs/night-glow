...
Add deterministic manifests, atmospheric transfer tables, terrain/surface products, catalogue tiling, diffuse-sky products, and independent adapters for both Environment Atlas products. Consume the emission-domain and atmosphere-domain boundary fixtures before any regional integration. Generate a small geographic/sky fixture including a heterogeneous city-plume-to-rural path before global products.
