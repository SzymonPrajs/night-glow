...
| D-009 | Environment Atlas emission integration — **resolved by ADR 0001** | independent `EmissionRelease`; one-way decoder dependency or conforming decoder; shared fixture | [ADR 0001](0001-consume-independent-environment-atlas.md) and [consumer contract](../contracts/EMISSION_RELEASE_CONTRACT.md) |
| D-010 | Emission source inference ownership — **resolved at project boundary** | raw satellite/inventory/OSM inference remains Environment Atlas emission domain; Physics owns only explicit source conversion/propagation policy | emission release contract plus end-to-end residual attribution |
...
| D-016 | Atmosphere-state release boundary — **resolved** | Environment Atlas owns independently released 4-D state; Physics owns spectral optical closure and propagation | [consumer contract](../contracts/ENVIRONMENT_ATLAS_CONTRACT.md) and atlas [handoff](../../../environment-atlas/docs/21-atmosphere-physics-handoff.md) |
