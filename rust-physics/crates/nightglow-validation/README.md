...
Every golden output records the exact model/data revisions that created it. A golden image cannot override a failed physical invariant. See [Validation plan](../../docs/VALIDATION_PLAN.md).
