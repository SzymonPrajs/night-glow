...
- [ ] Decide whether `emission-atlas/` becomes a workspace member or remains a versioned external dependency.
...
- [ ] Choose vertical atmosphere representation and supported weather inputs.
...
- [ ] Specify satellite-radiance inversion: atmospheric correction, view geometry, lunar/cloud/snow contamination, spectral reconstruction, and uncertainty.
- [ ] Incorporate inventories, luminaire spectra, angular emission, shielding, operating schedules, and OSM/built-surface redistribution without false precision.
- [ ] Define wavelength-dependent ground reflection and repeated atmosphere-surface coupling.
- [ ] Validate regional upward flux against independent inventories/measurements.
...
- [ ] Define absolute calibration, exposure, white balance, gamut mapping, and tone mapping without contaminating physics.
...
- [ ] Define catalogue/diffuse/emission/terrain tile formats and spatial indexes.
